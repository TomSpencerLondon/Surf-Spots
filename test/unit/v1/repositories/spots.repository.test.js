...
const spotsService = rewire('../../../../src/v1/repositories/spots.repository');

const getSpots = spotsService.__get__('getSpots');

describe('spots.repository.js', function () {
    describe('getSpots()', function () {
        it(`returns spots`, async function () {
